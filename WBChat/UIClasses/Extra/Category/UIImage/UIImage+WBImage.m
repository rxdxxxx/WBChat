...
+ (NSString *)getImagePath:(NSString *)name scale:(NSInteger)scale{
    NSURL *bundleUrl = [self bundleUrlWithResourcsName:@"WBUI"];
...
+ (NSURL *)bundleUrlWithResourcsName:(NSString *)name{
    return [[NSBundle mainBundle] URLForResource:name withExtension:@"bundle"];
}
@end
