...
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    if (self.touchMove) {
        ...
        [self reloadSubviewFrame];
        [self.recorderIndicatorView setStatus:!moveIn ? TLRecorderStatusWillCancel : TLRecorderStatusRecording];
...
- (TLRecorderIndicatorView *)recorderIndicatorView
{
    if (_recorderIndicatorView == nil) {
        _recorderIndicatorView = [[TLRecorderIndicatorView alloc] initWithFrame:CGRectMake(0, 0, 150, 150)];
    }
